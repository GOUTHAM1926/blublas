...
// Benchmark and accuracy test: BluBridge SM103a BF16 batched NT Cluster GEMM vs cuBLAS.
...
int main()
{
    ...
    {
        printf("[SKIP] SM103 BF16 NT Cluster kernel requires SM 10.3 (B300/sm_103a).\n"
