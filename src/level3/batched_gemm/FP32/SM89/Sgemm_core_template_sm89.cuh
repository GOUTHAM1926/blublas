...
//  * 3xTF32 emulation (+0x1000u bias trick on operands for accuracy)
//  * FMA-fused epilogue (__fmaf_rn) for cuBLAS-matching single-rounding behavior
//  */
...
// // PTX helpers
// // ---------------------------------------------------------------------------
// // 3xTF32 emulation: +0x1000u bias on operands rounds float -> tf32 with
// // round-to-nearest-even instead of truncation, closing accuracy gap vs cuBLAS.
// #ifndef MMA_TF32
...
//                 // FMA-fused epilogue: alpha-scale + beta-accumulate via __fmaf_rn
//                 // matches cuBLAS single-rounding behavior for accuracy.
